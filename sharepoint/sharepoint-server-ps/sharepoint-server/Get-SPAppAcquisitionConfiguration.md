...
### ------------EXAMPLE 1------- 
```powershell
PS C:\> Get-SPAppAcquisitionConfiguration -WebApplication https://localhost
```
...
### ------------EXAMPLE 2------- 
```powershell
PS C:\> Get-SPAppAcquisitionConfiguration -SiteSubscription https://localhost/sites/SharePointOnlineAdmin
```
