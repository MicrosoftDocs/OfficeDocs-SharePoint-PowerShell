...
### -----------------EXAMPLE 1--------------------- 
```powershell
PS C:\> Mount-SPContentDatabase "MyDatabase" -DatabaseServer "MyServer" -WebApplication https://sitename
```
...
### -----------------EXAMPLE 2--------------------- 
```powershell
PS C:\> Mount-SPContentDatabase "MyDatabase" -DatabaseServer "MyServer" -WebApplication https://sitename -NoB2BSiteUpgrade
```
