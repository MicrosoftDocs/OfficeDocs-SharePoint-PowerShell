...
online version: https://docs.microsoft.com/powershell/module/sharepoint-server/switch-spcertificate
...
### ------------EXAMPLE-----------
```powershell
PS C:\> Switch-SPCertificate -Identity "Team Sites Certificate (2020)" -NewCertificate "Team Sites Certificate (2021)"
```
