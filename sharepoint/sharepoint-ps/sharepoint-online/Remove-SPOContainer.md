...
The `Remove-SPOContainer` cmdlet deletes a SharePoint Embedded Container and puts it in the Recycle Bin. A Container that is deleted will no longer be retrieved by the [`Get-SPOContainer`](./Get-SPOContainer.md) cmdlet.
