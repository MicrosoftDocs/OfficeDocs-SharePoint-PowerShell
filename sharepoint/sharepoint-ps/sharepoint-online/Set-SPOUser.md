...
If the UserType property of an existing user is changed in Azure AD from Member to Guest and vice-versa, this parameter can be used to update it in SharePoint Online.
