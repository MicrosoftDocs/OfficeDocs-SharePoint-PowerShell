...
Allows custom script on a specific site. See [Allow or prevent custom script](/en-us/sharepoint/allow-or-prevent-custom-script) for more information.
...
### -NoScriptSite
Specifies if a site allows custom script or not. See [Allow or prevent custom script](/en-us/sharepoint/allow-or-prevent-custom-script) for more information.
