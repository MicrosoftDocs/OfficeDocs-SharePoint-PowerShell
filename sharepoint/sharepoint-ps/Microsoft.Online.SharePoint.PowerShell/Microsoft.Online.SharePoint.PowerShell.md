...
This cmdlet allows SharePoint administrators to check the current configuration of the restricted site creation feature for apps. Note: This feature is currently in preview and may not be available in your tenant.
